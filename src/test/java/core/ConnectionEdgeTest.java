...
class ConnectionEdgeTest extends SoftwareTest {
    @Test
    void testToString() {
        var expected = "(7)Lakshmi is GREAT GREAT GRANDMOTHER of (6)Pranavi RelationLevel: 4\n";
    ...
    @Test
    void testToString1() {
        var expected = "(6)Pranavi is GREAT GREAT GRANDDAUGHTER of (7)Lakshmi RelationLevel: -4\n";
